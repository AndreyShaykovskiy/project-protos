...
const file_proto_task_proto_rawDesc = "" +
	...
	"\tListTasks\x12\x16.google.protobuf.Empty\x1a\x17.task.ListTasksResponseB8Z6github.com/AndreyShaykovskiy/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_proto_depIdxs = []int32{
	...
	0, // 5: task.TaskService.DeleteTask:input_type -> task.Task
	4, // 6: task.TaskService.ListTasks:input_type -> google.protobuf.Empty
	...
	4, // 10: task.TaskService.DeleteTask:output_type -> google.protobuf.Empty
	3, // 11: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
